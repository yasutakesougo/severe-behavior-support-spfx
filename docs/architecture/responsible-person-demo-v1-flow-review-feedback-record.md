...
| RPF-007 | DEMO-UX-14 | `decision-demo-ux-14-saving-progress-observability-selection.md` | GO（2026-08-13）/ Implementation COMPLETE + Verification PASS（PR #330 Draft；Ready NOT AUTHORIZED） |
