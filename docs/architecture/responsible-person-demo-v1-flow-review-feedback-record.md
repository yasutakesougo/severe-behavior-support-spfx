...
| RPF-002 | daily-record | CHANGE | 入力欄は見えるが何もできない | 未記録選択→記録画面→入力イメージまで通す。実保存 HOLD | SELECTED / LOCKED（Implementation Start 未認可） | DEMO-UX-9 |
...
| RPF-002 | DEMO-UX-9 | `decision-demo-ux-9-daily-record-experience-selection.md` | NOT AUTHORIZED |
