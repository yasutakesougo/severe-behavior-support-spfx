...
| RPF-003 | users | CHANGE | 状態フィルタが無効 | 合成データだけで絞り込み可能にする | IMPLEMENTING（Implementation Start GO；Ready未） | DEMO-UX-8 |
...
| RPF-003 | DEMO-UX-8 | `decision-demo-ux-8-users-list-status-filter-selection.md` | GO（2026-08-12）/ COMPLETE pending verification |
