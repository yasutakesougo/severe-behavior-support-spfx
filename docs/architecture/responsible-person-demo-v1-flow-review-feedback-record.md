...
| RPF-002 | daily-record | CHANGE | 入力欄は見えるが何もできない | 未記録選択→記録画面→入力イメージまで通す。実保存 HOLD | IMPLEMENTING（Implementation Start GO；Ready未） | DEMO-UX-9 |
...
| RPF-002 | DEMO-UX-9 | `decision-demo-ux-9-daily-record-experience-selection.md` | GO（2026-08-12）/ COMPLETE pending verification |
