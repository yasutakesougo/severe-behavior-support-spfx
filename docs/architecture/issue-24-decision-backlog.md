...
| Issue #19 / GOV-AUD residual governance | **track SELECTED**（[`decision-issue-19-residual-governance-selection.md`](./decision-issue-19-residual-governance-selection.md)）。02/03/04/05(retention)/06 Accepted；01/07〜10/post-retention OPEN；first residual NOT SELECTED | — |
