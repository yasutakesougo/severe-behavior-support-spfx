...
GOV-AUD-05 / DEC-012（retention prohibition）: Accepted / LOCKED / Option A
  ...
  post-retention deletion: unit SELECTED / Option NOT SELECTED（[`decision-gov-aud-05-dec-012-post-retention-deletion-selection.md`](./decision-gov-aud-05-dec-012-post-retention-deletion-selection.md)）
