...
| Issue #19 / GOV-AUD residual governance | **track SELECTED**（[`decision-issue-19-residual-governance-selection.md`](./decision-issue-19-residual-governance-selection.md)）。02/03/04/05(retention)/06 Accepted；**GOV-AUD-01 unit SELECTED**（Option NOT SELECTED；[`decision-gov-aud-01-handoff-canonical-source-selection.md`](./decision-gov-aud-01-handoff-canonical-source-selection.md)）；07〜10/post-retention OPEN | — |
