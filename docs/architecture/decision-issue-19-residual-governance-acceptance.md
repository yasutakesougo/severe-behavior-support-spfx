...
Current residual unit = SELECTED / LOCKED（post-retention deletion；Option NOT SELECTED）
...
Consumed:
  ...
  post-retention deletion unit SELECT = Decision-GOV-AUD-05-POST-RETENTION-SELECTION-1（Option NOT SELECTED）
