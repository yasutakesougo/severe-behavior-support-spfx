...
Prior residual Option = CONSUMED（GOV-AUD-07 Accepted / Option A）
Current residual unit = SELECTED / LOCKED（GOV-AUD-08；Option NOT SELECTED）
...
Consumed:
  ...
  GOV-AUD-08 unit SELECT = Decision-GOV-AUD-08-SELECTION-1（Option NOT SELECTED）
