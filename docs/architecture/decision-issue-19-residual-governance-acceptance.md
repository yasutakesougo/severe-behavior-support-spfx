...
Current residual Option = CONSUMED（GOV-RULE-12 Accepted / Option B）
...
Consumed:
  ...
  GOV-RULE-12 Option B = Accepted / LOCKED

Next:
  1. GOV-RULE-12 Option B Acceptance PR: IR → Human Ready → Human Merge
