...
Current residual Option = CONSUMED（GOV-RULE-11 Fill-in Accepted）
...
Consumed:
  ...
  GOV-RULE-11 Fill-in = Accepted / LOCKED

Next:
  1. GOV-RULE-11 Fill-in Acceptance PR: IR → Human Ready → Human Merge
