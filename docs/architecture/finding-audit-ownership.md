...
| `GOV-AUD-07` | バックアップ・復元の一次責任者 | Issue #19（**unit SELECTED** / Option NOT SELECTED。正本 [`decision-gov-aud-07-backup-restore-owner-selection.md`](./decision-gov-aud-07-backup-restore-owner-selection.md) / packet [`decision-gov-aud-07-backup-restore-owner-decision-packet.md`](./decision-gov-aud-07-backup-restore-owner-decision-packet.md)。DEC-015 自動 Accepted しない） |
| `DEC-015` | バックアップ・復元責任者 | Issue #8（整合要；GOV-AUD-07 unit SELECTED では自動 Accepted しない） |
