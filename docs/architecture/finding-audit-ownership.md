...
| `GOV-PERF-02` | 合成記録量 | Issue #19（**SELECTED / LOCKED / HOLD** — 件数・年数 VALUE NOT DETERMINED。正本 同上 bundle） |
...
| `GOV-PERF-06` | 3秒・5秒目標の適用条件 | Issue #19（**SELECTED / LOCKED / HOLD** — cold/warm × median/p95 適用 NOT DETERMINED。正本 同上 bundle） |
| `GOV-PERF-07` | 基準端末 | Issue #19（**SELECTED / LOCKED / HOLD** — 端末仕様 NOT DETERMINED。正本 同上 bundle） |
| `GOV-PERF-08` | 対象ブラウザ | Issue #19（**SELECTED / LOCKED / HOLD** — ブラウザ NOT DETERMINED。自動採択禁止。正本 同上 bundle） |
| `GOV-PERF-09` | 基準ネットワーク | Issue #19（**SELECTED / LOCKED / HOLD** — ネットワーク条件 NOT DETERMINED。一時障害 tip は recommendation のみ。正本 同上 bundle） |
