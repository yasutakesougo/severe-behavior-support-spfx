...
| 見直し通知開始（GOV-RULE-07） | Issue #16 / #19（判断） | **READY_FOR_HUMAN_DECISION**。packet [`decision-gov-rule-07-notice-decision-packet.md`](./decision-gov-rule-07-notice-decision-packet.md) | 日数未採択。GOV-RULE-08 と分離。Agent 発明禁止。Implementation HOLD |
