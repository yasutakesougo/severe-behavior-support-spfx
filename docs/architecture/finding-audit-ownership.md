...
| `GOV-AUD-01〜10`回答 | Issue #19 | 回答正本 | **track SELECTED**（[`decision-issue-19-residual-governance-selection.md`](./decision-issue-19-residual-governance-selection.md)）。**01 = Accepted / Option C**（[`decision-gov-aud-01-handoff-canonical-source-option-c-acceptance.md`](./decision-gov-aud-01-handoff-canonical-source-option-c-acceptance.md)；identity NOT YET PROVIDED）。02 / 03 / 04 / 05(retention) / 06 = Accepted。07〜10 / post-retention deletion = OPEN |
...
| `GOV-AUD-01` | handoffの正本 | Issue #19（**Accepted / LOCKED / Option C** — 会議・議事録側が業務正本 / アプリは参照 ID + 状態。identity fields NOT YET PROVIDED。正本 [`decision-gov-aud-01-handoff-canonical-source-option-c-acceptance.md`](./decision-gov-aud-01-handoff-canonical-source-option-c-acceptance.md) / packet [`decision-gov-aud-01-handoff-canonical-source-decision-packet.md`](./decision-gov-aud-01-handoff-canonical-source-decision-packet.md)） |
