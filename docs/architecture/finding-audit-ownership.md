...
| 見直し周期 practice cadence（GOV-RULE-06） | Issue #16 / #19（判断）・契約 docs | **Accepted**（2026-08-09）。正本 [`decision-gov-rule-06-review-cadence-acceptance.md`](./decision-gov-rule-06-review-cadence-acceptance.md) / [`review-cadence-contract.md`](./review-cadence-contract.md) / source review [`decision-gov-rule-06-review-cadence-source-review.md`](./decision-gov-rule-06-review-cadence-source-review.md) | `duration_days=90` 変換禁止。通知・超過は HOLD。Implementation HOLD |
| 見直し周期の基準日（GOV-RULE-05） | Issue #16 / #19（判断）・契約 docs | **Accepted**（2026-08-09）。初回=支援計画有効開始日 / 以降=前回見直し日。正本 [`decision-gov-rule-05-review-anchor-acceptance.md`](./decision-gov-rule-05-review-anchor-acceptance.md) / [`review-anchor-contract.md`](./review-anchor-contract.md) | 物理列・due 算出は未決。GOV-RULE-08 HOLD。Implementation HOLD |
| 見直し通知開始（GOV-RULE-07） | Issue #16 / #19（判断）・契約 docs | **Accepted**（2026-08-09）/ Option C。対象暦月に入ったら通知 / precision = approximate。正本 [`decision-gov-rule-07-notice-acceptance.md`](./decision-gov-rule-07-notice-acceptance.md) / [`review-notice-contract.md`](./review-notice-contract.md) | 日数変換禁止。通知 ≠ overdue / 違反。GOV-RULE-08 HOLD。Implementation HOLD |
...
| DEC正本台帳 | Issue #8 | `DEC-001〜018`。FindingSeverity 不採用は **DEC-018**（comment `5225426738`）。VOCAB Canonical COMPLETE。FindingCode catalog ownership は Decision-FC-1 Accepted（Option B / 新 DEC・番号 UNASSIGNED）。delivery は Decision-FC-2 Accepted（Option C）。FC-3 snapshot logical contract は Accepted / Option C。FC-4 catalog version identifier は Accepted / Option C。FC-5 representation ownership は Accepted / Option C。FC-6 businessOwnershipRef は Accepted / Option C。PURPOSE は MHLW-first RECORDED |
