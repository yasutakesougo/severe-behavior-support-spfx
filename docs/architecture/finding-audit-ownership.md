...
| `GOV-STAFF-06` | 資格・研修マスターの正本管理者 | Issue #19（**Accepted / LOCKED / Option B** — 法人業務責任者。正本 [`decision-gov-staff-06-qualification-training-master-owner-option-b-acceptance.md`](./decision-gov-staff-06-qualification-training-master-owner-option-b-acceptance.md) / packet [`decision-gov-staff-06-qualification-training-master-owner-decision-packet.md`](./decision-gov-staff-06-qualification-training-master-owner-decision-packet.md)。07+ 同時 SELECT しない。正本管理者 ≠ 確認者。UI/個人名未発明） |
