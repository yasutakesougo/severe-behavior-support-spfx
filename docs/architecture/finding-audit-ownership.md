...
| `GOV-AUD-01〜10`回答 | Issue #19 | 回答正本 | **track SELECTED**（[`decision-issue-19-residual-governance-selection.md`](./decision-issue-19-residual-governance-selection.md)）。**01 = Accepted / Option C + identity fill-in LOCKED**（[`decision-gov-aud-01-handoff-canonical-source-option-c-acceptance.md`](./decision-gov-aud-01-handoff-canonical-source-option-c-acceptance.md) / [`decision-gov-aud-01-identity-fill-in-acceptance.md`](./decision-gov-aud-01-identity-fill-in-acceptance.md)）。02 / 03 / 04 / 05(retention) / 06 = Accepted。**07 = Accepted / Option A**（[`decision-gov-aud-07-backup-restore-owner-option-a-acceptance.md`](./decision-gov-aud-07-backup-restore-owner-option-a-acceptance.md)；DEC-015 NOT ACCEPTED）。**08 = Accepted / Option B**（[`decision-gov-aud-08-post-recovery-confirmer-option-b-acceptance.md`](./decision-gov-aud-08-post-recovery-confirmer-option-b-acceptance.md)）。**09 = Accepted / Option A**（[`decision-gov-aud-09-resume-approver-option-a-acceptance.md`](./decision-gov-aud-09-resume-approver-option-a-acceptance.md)）。**10 = Accepted / fill-in（role names）**（[`decision-gov-aud-10-incident-contact-path-fill-in-acceptance.md`](./decision-gov-aud-10-incident-contact-path-fill-in-acceptance.md)）。**GOV-RULE-09 = Accepted / Option B**（[`decision-gov-rule-09-rule-content-owner-option-b-acceptance.md`](./decision-gov-rule-09-rule-content-owner-option-b-acceptance.md)）。**GOV-RULE-10 = Accepted / Option C**（[`decision-gov-rule-10-change-approver-option-c-acceptance.md`](./decision-gov-rule-10-change-approver-option-c-acceptance.md)）。**GOV-RULE-11 = Accepted / fill-in**（[`decision-gov-rule-11-value-boundary-fill-in-acceptance.md`](./decision-gov-rule-11-value-boundary-fill-in-acceptance.md)）。**GOV-RULE-12 = Accepted / Option B**（[`decision-gov-rule-12-version-correction-option-b-acceptance.md`](./decision-gov-rule-12-version-correction-option-b-acceptance.md)）。**GOV-STAFF-01 = Accepted / Option C**（[`decision-gov-staff-01-transfer-retirement-confirmer-option-c-acceptance.md`](./decision-gov-staff-01-transfer-retirement-confirmer-option-c-acceptance.md)）。**GOV-STAFF-02 = Accepted / Option B**（[`decision-gov-staff-02-entra-group-removal-operator-option-b-acceptance.md`](./decision-gov-staff-02-entra-group-removal-operator-option-b-acceptance.md)）。**GOV-STAFF-03 = Accepted / Option A**（[`decision-gov-staff-03-access-suspension-deadline-option-a-acceptance.md`](./decision-gov-staff-03-access-suspension-deadline-option-a-acceptance.md)）。**GOV-STAFF-04 = Accepted / Option C**（[`decision-gov-staff-04-user-transfer-ledger-storage-option-c-acceptance.md`](./decision-gov-staff-04-user-transfer-ledger-storage-option-c-acceptance.md)）。**GOV-STAFF-05 = Accepted / Option C**（[`decision-gov-staff-05-post-transfer-past-record-access-option-c-acceptance.md`](./decision-gov-staff-05-post-transfer-past-record-access-option-c-acceptance.md)）。**GOV-STAFF-06 = Accepted / Option B**（[`decision-gov-staff-06-qualification-training-master-owner-option-b-acceptance.md`](./decision-gov-staff-06-qualification-training-master-owner-option-b-acceptance.md)）。**GOV-STAFF-07〜12 = Accepted（bundle）**（[`decision-gov-staff-06-12-qualification-training-bundle-option-acceptance.md`](./decision-gov-staff-06-12-qualification-training-bundle-option-acceptance.md)）。**GOV-RULE-01〜04 bundle**（[`decision-gov-rule-01-04-observation-cycle-bundle-option-acceptance.md`](./decision-gov-rule-01-04-observation-cycle-bundle-option-acceptance.md)；01/04 HOLD；02/03 Option A；05〜12 CONFIRMED）。**post-retention deletion = Accepted / LOCKED / Option C（PR #284 MERGED）**。**GOV-PERF-01〜11 = MERGED（PR #285）**。**現行単位 = GOV-RULE-01 / 04 Evidence Bundle（SELECTED / LOCKED；01 HOLD LIFT CANDIDATE；04 HOLD UNCHANGED；Draft PR pending）**（[`decision-gov-rule-01-04-evidence-bundle-selection.md`](./decision-gov-rule-01-04-evidence-bundle-selection.md)）。RULE-01 Option Acceptance / RULE-04 法人運用 / PERF HOLD解除 Acceptance = OPEN；next residual after this bundle NOT SELECTED |
...
| `GOV-AUD-05` | 物理削除方針 | Issue #19（**Accepted / LOCKED / Option A** — 法定保存期間中の完全削除禁止 / 5年。自動物理削除 NOT ADOPTED。経過後 = **Accepted / LOCKED / Option C** — 初期版は経過後完全削除機能なし [`decision-gov-aud-05-dec-012-post-retention-deletion-option-c-acceptance.md`](./decision-gov-aud-05-dec-012-post-retention-deletion-option-c-acceptance.md)。保存期間中禁止の正本 [`decision-gov-aud-05-dec-012-retention-delete-prohibition-acceptance.md`](./decision-gov-aud-05-dec-012-retention-delete-prohibition-acceptance.md)） |
| `GOV-AUD-06` / `DEC-011` | AuditLog・業務データの保存期間 | Issue #19 / Issue #8（Decision-AUD-RET-1 **Accepted**） |
| `DEC-012` | 論理削除データの完全削除方針 | Issue #8（**Accepted / LOCKED / Option A** — GOV-AUD-05 と同一 Acceptance で保存期間中禁止。経過後 = **Accepted / LOCKED / Option C** — [`decision-gov-aud-05-dec-012-post-retention-deletion-option-c-acceptance.md`](./decision-gov-aud-05-dec-012-post-retention-deletion-option-c-acceptance.md)。保存期間中禁止の正本 [`decision-gov-aud-05-dec-012-retention-delete-prohibition-acceptance.md`](./decision-gov-aud-05-dec-012-retention-delete-prohibition-acceptance.md)） |
...
| `GOV-AUD-08` | 復旧後の業務確認者 | Issue #19（**Accepted / LOCKED / Option B** — 業務責任者または指定確認者。正本 [`decision-gov-aud-08-post-recovery-confirmer-option-b-acceptance.md`](./decision-gov-aud-08-post-recovery-confirmer-option-b-acceptance.md) / packet [`decision-gov-aud-08-post-recovery-confirmer-decision-packet.md`](./decision-gov-aud-08-post-recovery-confirmer-decision-packet.md)。技術復旧（GOV-AUD-07）と業務確認を分離。09/10 同時 SELECT しない） |
| `GOV-AUD-09` | 再開承認者 | Issue #19（**Accepted / LOCKED / Option A** — 事業所管理者。正本 [`decision-gov-aud-09-resume-approver-option-a-acceptance.md`](./decision-gov-aud-09-resume-approver-option-a-acceptance.md) / packet [`decision-gov-aud-09-resume-approver-decision-packet.md`](./decision-gov-aud-09-resume-approver-decision-packet.md)。技術復旧・業務確認と分離。10 同時 SELECT しない） |
| `GOV-AUD-10` | 重大障害時の連絡経路 | Issue #19（**Accepted / LOCKED（fill-in / role names）** — 第一報・再開判断=事業所管理者 / 技術=Microsoft 365管理者 / 業務=業務責任者または指定確認者 / 個人情報事故=法人管理者。正本 [`decision-gov-aud-10-incident-contact-path-fill-in-acceptance.md`](./decision-gov-aud-10-incident-contact-path-fill-in-acceptance.md) / packet [`decision-gov-aud-10-incident-contact-path-decision-packet.md`](./decision-gov-aud-10-incident-contact-path-decision-packet.md)。個人名・電話・メールは未確定） |
| `GOV-RULE-09` | ルール内容の責任者 | Issue #19（**Accepted / LOCKED / Option B** — 法人業務責任者。正本 [`decision-gov-rule-09-rule-content-owner-option-b-acceptance.md`](./decision-gov-rule-09-rule-content-owner-option-b-acceptance.md) / packet [`decision-gov-rule-09-rule-content-owner-decision-packet.md`](./decision-gov-rule-09-rule-content-owner-decision-packet.md)。内容責任 ≠ 変更承認） |
| `GOV-RULE-10` | ルール変更の承認者 | Issue #19（**Accepted / LOCKED / Option C** — 業務責任者が内容確認し、法人管理者が承認。正本 [`decision-gov-rule-10-change-approver-option-c-acceptance.md`](./decision-gov-rule-10-change-approver-option-c-acceptance.md) / packet [`decision-gov-rule-10-change-approver-decision-packet.md`](./decision-gov-rule-10-change-approver-decision-packet.md)。変更承認 ≠ 境界分類。承認 UI 未発明） |
| `GOV-RULE-11` | 制度値と法人運用値の境界 | Issue #19（**Accepted / LOCKED（fill-in）** — 制度固定/事業所=確定なし；法人運用=GOV-RULE-05〜10。正本 [`decision-gov-rule-11-value-boundary-fill-in-acceptance.md`](./decision-gov-rule-11-value-boundary-fill-in-acceptance.md) / packet [`decision-gov-rule-11-value-boundary-decision-packet.md`](./decision-gov-rule-11-value-boundary-decision-packet.md)。90日変換禁止。境界 ≠ 版訂正） |
| `GOV-RULE-12` | 過去ルール版の訂正 | Issue #19（**Accepted / LOCKED / Option B** — 訂正版を新規作成し、旧版を保持。正本 [`decision-gov-rule-12-version-correction-option-b-acceptance.md`](./decision-gov-rule-12-version-correction-option-b-acceptance.md) / packet [`decision-gov-rule-12-version-correction-decision-packet.md`](./decision-gov-rule-12-version-correction-decision-packet.md)。訂正 UI 未発明） |
| `GOV-STAFF-01` | 異動・退職情報の確定者 | Issue #19（**Accepted / LOCKED / Option C** — 事業所管理者が起票し、法人担当が確定。正本 [`decision-gov-staff-01-transfer-retirement-confirmer-option-c-acceptance.md`](./decision-gov-staff-01-transfer-retirement-confirmer-option-c-acceptance.md) / packet [`decision-gov-staff-01-transfer-retirement-confirmer-decision-packet.md`](./decision-gov-staff-01-transfer-retirement-confirmer-decision-packet.md)。確定 ≠ Entra 削除実施。UI/個人名未発明） |
| `GOV-STAFF-02` | Entra IDグループから削除する実施者 | Issue #19（**Accepted / LOCKED / Option B** — Microsoft 365管理者。正本 [`decision-gov-staff-02-entra-group-removal-operator-option-b-acceptance.md`](./decision-gov-staff-02-entra-group-removal-operator-option-b-acceptance.md) / packet [`decision-gov-staff-02-entra-group-removal-operator-decision-packet.md`](./decision-gov-staff-02-entra-group-removal-operator-decision-packet.md)。Entra mutation 未認可。権限停止期限 ≠ 削除実施者） |
| `GOV-STAFF-03` | 権限停止期限 | Issue #19（**Accepted / LOCKED / Option A** — 異動・退職の発効日時までに権限停止。正本 [`decision-gov-staff-03-access-suspension-deadline-option-a-acceptance.md`](./decision-gov-staff-03-access-suspension-deadline-option-a-acceptance.md) / packet [`decision-gov-staff-03-access-suspension-deadline-decision-packet.md`](./decision-gov-staff-03-access-suspension-deadline-decision-packet.md)。Entra mutation / 自動化未認可。台帳保存先 ≠ 権限停止期限） |
| `GOV-STAFF-04` | 利用者異動台帳の保存先 | Issue #19（**Accepted / LOCKED / Option C** — 専用の法人共通台帳。支援内容は保存しない。正本 [`decision-gov-staff-04-user-transfer-ledger-storage-option-c-acceptance.md`](./decision-gov-staff-04-user-transfer-ledger-storage-option-c-acceptance.md) / packet [`decision-gov-staff-04-user-transfer-ledger-storage-decision-packet.md`](./decision-gov-staff-04-user-transfer-ledger-storage-decision-packet.md)。SharePoint mutation / 支援内容保存未認可。閲覧範囲 ≠ 台帳保存先） |
| `GOV-STAFF-05` | 異動後の過去記録の閲覧範囲 | Issue #19（**Accepted / LOCKED / Option C** — 記録時点の SiteId を維持し、異動先の閲覧は明示権限がある範囲だけ。正本 [`decision-gov-staff-05-post-transfer-past-record-access-option-c-acceptance.md`](./decision-gov-staff-05-post-transfer-past-record-access-option-c-acceptance.md) / packet [`decision-gov-staff-05-post-transfer-past-record-access-decision-packet.md`](./decision-gov-staff-05-post-transfer-past-record-access-decision-packet.md)。ACL/SiteId 実装・包括閲覧未認可。正本管理者 ≠ 閲覧範囲） |
| `GOV-STAFF-06` | 資格・研修マスターの正本管理者 | Issue #19（**Accepted / LOCKED / Option B** — 法人業務責任者。正本 [`decision-gov-staff-06-qualification-training-master-owner-option-b-acceptance.md`](./decision-gov-staff-06-qualification-training-master-owner-option-b-acceptance.md)。bundle CONFIRMED / UNCHANGED） |
| `GOV-STAFF-07` | 資格・研修情報の確認者 | Issue #19（**Accepted / LOCKED / Option C** — 法人業務責任者または指定確認者。正本 [`decision-gov-staff-06-12-qualification-training-bundle-option-acceptance.md`](./decision-gov-staff-06-12-qualification-training-bundle-option-acceptance.md)。個人名・指名手続未確定） |
| `GOV-STAFF-08` | 研修割合の分母 | Issue #19（**Accepted / LOCKED / Option C** — 対象職種・雇用区分・所属期間をルールで明示した職員だけ。具体値 NOT INVENTED。正本 同上 bundle） |
| `GOV-STAFF-09` | 兼務者の集計 | Issue #19（**Accepted / LOCKED / Option C** — 配置時間・勤務割合等の明示条件 + 二重計上防止方針。閾値 NOT INVENTED。正本 同上 bundle） |
| `GOV-STAFF-10` | 休職・長期不在・短期応援・派遣委託 | Issue #19（**Accepted / LOCKED / Option C-based** — 全区分 C（期間・勤務実態）。閾値 NOT INVENTED。正本 同上 bundle） |
| `GOV-STAFF-11` | 期限のない資格・研修 | Issue #19（**Accepted / LOCKED / Option B** — 法人が定期確認日を設定。validTo/周期 NOT DETERMINED。正本 同上 bundle） |
| `GOV-STAFF-12` | 証跡欠損時の扱い | Issue #19（**Accepted / LOCKED / Option C** — missing / 算定不能 / 管理者確認待ち。未修了断定禁止・修了扱い禁止。正本 同上 bundle） |
| `GOV-RULE-01` | 行動関連点数の評価周期 | Issue #19（**HOLD LIFT CANDIDATE** — Evidence [`decision-gov-rule-01-evaluation-cycle-evidence-packet.md`](./decision-gov-rule-01-evaluation-cycle-evidence-packet.md)。≠ Accepted；3年固定再採点禁止） |
| `GOV-RULE-02` | 観察期間の起算日 | Issue #19（**Accepted / LOCKED / Option A** — 支援計画の有効開始日。正本 同上 bundle。新規日付計算規則発明禁止） |
| `GOV-RULE-03` | 観察期間の終了日 | Issue #19（**Accepted / LOCKED / Option A** — 見直し実施日の前日。正本 同上 bundle。TZ/列型未決定） |
| `GOV-RULE-04` | 必要観察件数 | Issue #19（**HOLD / UNCHANGED / ORG_POLICY** — Evidence [`decision-gov-rule-04-observation-count-evidence-packet.md`](./decision-gov-rule-04-observation-count-evidence-packet.md)。件数発明禁止） |
| `GOV-PERF-01` | 通常規模の合成利用者数 | Issue #19（**Accepted / LOCKED / Option A** — 30件 / 試行版 synthetic baseline。本番上限ではない。正本 [`decision-gov-perf-01-11-performance-bundle-option-acceptance.md`](./decision-gov-perf-01-11-performance-bundle-option-acceptance.md)） |
| `GOV-PERF-02` | 合成記録量 | Issue #19（**SELECTED / LOCKED / HOLD / UNCHANGED** — Packet [`decision-gov-perf-02-synthetic-volume-decision-packet.md`](./decision-gov-perf-02-synthetic-volume-decision-packet.md)；解除 NOT PERFORMED） |
| `GOV-PERF-03` | 正式受入のキャッシュ条件 | Issue #19（**Accepted / LOCKED / Option C** — cold と warm を別々に判定。正本 同上 bundle） |
| `GOV-PERF-04` | 測定回数 | Issue #19（**Accepted / LOCKED / Option C** — 20回以上。測定開始ではない。正本 同上 bundle） |
| `GOV-PERF-05` | 合否に使う統計値 | Issue #19（**Accepted / LOCKED / Option D** — 中央値・p95・最大値。max=自動FAIL発明禁止。正本 同上 bundle） |
| `GOV-PERF-06` | 3秒・5秒目標の適用条件 | Issue #19（**SELECTED / LOCKED / HOLD / UNCHANGED** — Packet [`decision-gov-perf-06-sla-applicability-decision-packet.md`](./decision-gov-perf-06-sla-applicability-decision-packet.md)；解除 NOT PERFORMED） |
| `GOV-PERF-07` | 基準端末 | Issue #19（**SELECTED / LOCKED / HOLD / UNCHANGED** — obs [`decision-gov-perf-07-baseline-device-observation.md`](./decision-gov-perf-07-baseline-device-observation.md)；試行業務端末 NOT OBSERVED） |
| `GOV-PERF-08` | 対象ブラウザ | Issue #19（**SELECTED / LOCKED / HOLD / UNCHANGED** — obs [`decision-gov-perf-08-browser-observation.md`](./decision-gov-perf-08-browser-observation.md)；業務ブラウザ NOT OBSERVED） |
| `GOV-PERF-09` | 基準ネットワーク | Issue #19（**SELECTED / LOCKED / HOLD / UNCHANGED** — obs [`decision-gov-perf-09-network-observation.md`](./decision-gov-perf-09-network-observation.md)；試行ネットワーク NOT OBSERVED） |
| `GOV-PERF-10` | 拡張・ストレス条件 | Issue #19（**Accepted / LOCKED / Option A** — P1通常規模だけを試行版必須。Production GO ではない。正本 同上 bundle） |
| `GOV-PERF-11` | 目標超過時の判断者 | Issue #19（**Accepted / LOCKED / Option D** — 開発分析 + 業務責任者・法人管理者が判断。正本 同上 bundle） |
| `DEC-015` | バックアップ・復元責任者 | Issue #8（整合要；GOV-AUD-07 Option A Accepted でも自動 Accepted しない / 別 sync） |

保存期間中の完全削除禁止は Accepted（GOV-AUD-05 / DEC-012）。**経過後 = Accepted / LOCKED / Option C**（初期版は経過後完全削除機能なし；[`decision-gov-aud-05-dec-012-post-retention-deletion-option-c-acceptance.md`](./decision-gov-aud-05-dec-012-post-retention-deletion-option-c-acceptance.md)）。自動削除・cleanup 実装は NOT ADOPTED / HOLD。
