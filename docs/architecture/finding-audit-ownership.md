...
| 見直しモニタリング時期表示・通知（Decision-RD-3） | Issue #16 / #19（判断）・#24（相対判定分離） | **Accepted / LOCKED**（2026-08-09）。「3か月に1回程度」を目安として表示・通知 / informational only。正本 [`decision-rd-3-monitoring-guidance-acceptance.md`](./decision-rd-3-monitoring-guidance-acceptance.md) / [`review-monitoring-guidance-contract.md`](./review-monitoring-guidance-contract.md) | 期限超過・警告・業務制限・90日固定 NOT ADOPTED。`evaluateReviewDueRelativeToAsOf` UNCHANGED。Implementation HOLD |
