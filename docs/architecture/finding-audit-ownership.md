...
| `GOV-AUD-01〜10`回答 | Issue #19 | 回答正本 | **track SELECTED**（[`decision-issue-19-residual-governance-selection.md`](./decision-issue-19-residual-governance-selection.md)）。02 / 03 / 04 / 05(retention) / 06 = Accepted。**first residual = GOV-AUD-01 SELECTED**（[`decision-gov-aud-01-handoff-canonical-source-selection.md`](./decision-gov-aud-01-handoff-canonical-source-selection.md)；Option NOT SELECTED）。07〜10 / post-retention deletion = OPEN |
...
| `GOV-AUD-01` | handoffの正本 | Issue #19（**unit SELECTED** / Option NOT SELECTED。正本: [`decision-gov-aud-01-handoff-canonical-source-selection.md`](./decision-gov-aud-01-handoff-canonical-source-selection.md) / packet [`decision-gov-aud-01-handoff-canonical-source-decision-packet.md`](./decision-gov-aud-01-handoff-canonical-source-decision-packet.md)） |
