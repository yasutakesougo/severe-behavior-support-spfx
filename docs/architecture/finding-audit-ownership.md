...
| 支援計画シート役割（DEC-008） | Issue #8 / DEC-008 | **Accepted**。制度上の作成者=実践研修修了者 / 独立最終承認者=**NOT ADOPTED**。正本 [`decision-dec-008-acceptance.md`](./decision-dec-008-acceptance.md) / [`decision-dec-008-authoring-center-acceptance.md`](./decision-dec-008-authoring-center-acceptance.md) / [`decision-dec-008-final-approver-acceptance.md`](./decision-dec-008-final-approver-acceptance.md) | ロール実装 DO NOT START。独立承認ロールを発明しない |
