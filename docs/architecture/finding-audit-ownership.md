...
| `GOV-RULE-01` | 行動関連点数の評価周期 | Issue #19（**SELECTED / LOCKED / HOLD** — VALUE NOT DETERMINED。正本 [`decision-gov-rule-01-04-observation-cycle-bundle-option-acceptance.md`](./decision-gov-rule-01-04-observation-cycle-bundle-option-acceptance.md)。周期・条件発明禁止） |
...
| `GOV-RULE-04` | 必要観察件数 | Issue #19（**SELECTED / LOCKED / HOLD** — VALUE NOT DETERMINED。正本 同上 bundle。件数・集計方式発明禁止） |
