...
| `GOV-AUD-01〜10`回答 | Issue #19 | 回答正本 | **track SELECTED**（[`decision-issue-19-residual-governance-selection.md`](./decision-issue-19-residual-governance-selection.md)）。02 / 03 / 04 / 05(retention) / 06 = Accepted。01 / 07〜10 / post-retention deletion = OPEN。first residual = NOT SELECTED |
...
| `GOV-AUD-01` | handoffの正本 | Issue #19（**OPEN** / residual governance track SELECTED；first residual NOT SELECTED） |
