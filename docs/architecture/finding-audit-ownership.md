...
Decision-FC-6（CANDIDATE / businessOwnershipRef logical contract / NOT ACCEPTED）: docs/architecture/decision-fc-6-business-ownership-ref-logical-contract.md
...
Decision-FC-6 は CANDIDATE / NOT ACCEPTED（businessOwnershipRef logical contract）。
