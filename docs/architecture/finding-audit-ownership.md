...
| `GOV-STAFF-03` | 権限停止期限 | Issue #19（**unit SELECTED** / Option NOT SELECTED。Option A tip = SPECIFIED / NON-BINDING。正本 [`decision-gov-staff-03-access-suspension-deadline-selection.md`](./decision-gov-staff-03-access-suspension-deadline-selection.md) / packet [`decision-gov-staff-03-access-suspension-deadline-decision-packet.md`](./decision-gov-staff-03-access-suspension-deadline-decision-packet.md)。04+ 同時 SELECT しない。Entra mutation / 自動化未認可） |
