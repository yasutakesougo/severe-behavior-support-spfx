...
| `GOV-RULE-09` | ルール内容の責任者 | Issue #19（**unit SELECTED** / Option NOT SELECTED。正本 [`decision-gov-rule-09-rule-content-owner-selection.md`](./decision-gov-rule-09-rule-content-owner-selection.md) / packet [`decision-gov-rule-09-rule-content-owner-decision-packet.md`](./decision-gov-rule-09-rule-content-owner-decision-packet.md)。10/11/12 同時 SELECT しない） |
