...
| `GOV-RULE-12` | 過去ルール版の訂正 | Issue #19（**unit SELECTED** / Option NOT SELECTED。Option B tip = SPECIFIED / NON-BINDING。正本 [`decision-gov-rule-12-version-correction-selection.md`](./decision-gov-rule-12-version-correction-selection.md) / packet [`decision-gov-rule-12-version-correction-decision-packet.md`](./decision-gov-rule-12-version-correction-decision-packet.md)。訂正 UI 未発明） |
