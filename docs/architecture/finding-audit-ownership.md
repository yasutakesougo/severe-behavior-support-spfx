...
Decision-ILB-1 institutional/local boundary packet（OPEN）: docs/architecture/decision-ilb-1-institutional-local-boundary-decision-packet.md
Decision-ILB-1 residual Decision inventory（read-only / provisional）: docs/architecture/decision-ilb-1-residual-decision-inventory.md
