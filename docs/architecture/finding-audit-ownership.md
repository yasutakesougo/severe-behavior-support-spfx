...
| 見直し周期の基準日（GOV-RULE-05） | Issue #16 / #19（判断）・契約 docs | **Accepted**（2026-08-09）。初回=支援計画有効開始日 / 以降=前回見直し日。正本 [`decision-gov-rule-05-review-anchor-acceptance.md`](./decision-gov-rule-05-review-anchor-acceptance.md) / [`review-anchor-contract.md`](./review-anchor-contract.md) | 物理列・due 算出は未決。GOV-RULE-07/08 HOLD。Implementation HOLD |
