...
FindingCode A-1〜A-4 bundle content Decision packet（READY_FOR_HUMAN_DECISION）: docs/architecture/decision-findingcode-a14-bundle-content-decision-packet.md
