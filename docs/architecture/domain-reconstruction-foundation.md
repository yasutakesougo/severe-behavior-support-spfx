...
| SupportPlan状態遷移（狭域） | Issue #24 | Accepted `5211039927` / [`support-plan-status-transition.md`](./support-plan-status-transition.md)。許可5辺・allow/deny only。ロール・Active一意・期限・RuleSetVersionはHOLD |
