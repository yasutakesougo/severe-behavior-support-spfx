...
- SupportPlan status transition / Active一意性 / 観察期間メンバシップ / 見直し期限 asOf 相対判定 / RuleSetVersion選択は完了。残る SupportPlan 系は OP-3・RD-3・GOV-RULE-06（practice cadence Human Acceptance）・GOV-RULE-05/07/08 等の制度・フィールド Decision（[`issue-24-remaining-audit-post-rsv.md`](./issue-24-remaining-audit-post-rsv.md) / [`review-cadence-contract.md`](./review-cadence-contract.md)）
