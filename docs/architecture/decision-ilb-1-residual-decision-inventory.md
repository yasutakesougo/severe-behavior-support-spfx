...
Fifth residual Decision: SELECTED / A — AS-EC-1 Entry #2（Accepted / LOCKED / PASS·MET / FINAL CONSISTENT）
Sixth residual Decision: NOT SELECTED（packet OPEN — Entry #5/#6/#7 handling）
FindingCode: HOLD
A-5: HOLD
...
| **Decision-AS-EC-1** | AssessmentSnapshot 完全契約 Entry Criteria | 部分（業務保存・監査） | Entry #1 PASS / #2 PASS·MET / FINAL CONSISTENT（PR-J） / #3 DEC-009 Accepted / #4 GOV-AUD-03 / #8 plan FINAL CONSISTENT；#5/#6/#7 未 | はい（Entry 充足宣言） | 低 | overall Entry satisfied は別 Human 記録。Entry #2 正本 [`decision-as-ec-1-entry-2-ownership-pr-boundary-acceptance.md`](./decision-as-ec-1-entry-2-ownership-pr-boundary-acceptance.md)。第六 residual packet OPEN | **E**（overall HOLD） |
...
Order:
  ...
  6. Fifth residual: AS-EC-1 Entry #2 ownership / PR-J PASS / MET / FINAL CONSISTENT（DONE / CONSUMED）
  7. Sixth residual packet: OPEN（Entry #5 / #6 / #7 handling）
     Next residual: NOT SELECTED（Human が一件選ぶまで自動開始しない）
     packet: decision-ilb-1-sixth-residual-decision-selection-packet.md
