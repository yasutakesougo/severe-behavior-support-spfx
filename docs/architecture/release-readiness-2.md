...
## 1.1 Current-main reconciliation

```text
Product RC assessment basis:
  7944cea0fad20783f178ec613080283b98b5cca5

Current repository reconciliation basis:
  repository tip (origin/main):
  66219ae16c3f2ca1ebee7bbe5b479c8286ac79e8

This document assesses Product RC 7944cea... and was reconciled
against repository tip 66219ae....
66219ae... is not declared a replacement Product RC.
No later authority found on that basis changes the recorded:
  U1 = UNVERIFIED
  U2 = UNVERIFIED
  U3 = UNVERIFIED
