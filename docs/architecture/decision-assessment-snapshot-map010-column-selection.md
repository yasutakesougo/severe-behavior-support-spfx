...
Follow-up Decision / Packet ID: Decision-AS-MAP010-COLUMN-1
  ...
  contract candidate: assessment-snapshot-map010-column-contract.md
...
SELECTED / OPEN:
  ...
  Purpose = Decision-ready Internal Name / Display Name / Column Type /
...
This Selection does NOT authorize:
  ...
  VR-1 execution
  Internal Name invention as Accepted
...
| ID | unit | 結果 |
|---|---|---|
| **A** | MAP-AS-010 Column Contract Decision | **SELECTED** |
