...
先行 HOLD 正本: [`decision-sev-2-vocab-hold.md`](./decision-sev-2-vocab-hold.md)（V-C / superseded）
...
main before this canonicalization: b0cc1f75be274fda04f16bc339de76b1bd8cec8c
...
```text
Issue #8 DEC number: UNASSIGNED
Issue #8 new DEC recording: REQUIRED（本 docs 正本化とは別操作）
...
| **SEV-2-VOCAB**（本 Decision） | **Accepted / Option A / FindingSeverity NOT ADOPTED** |
| SEV-2-ASSIGN | **N/A / DO NOT START** |
...
- Issue #8 DEC 番号の採番・台帳本文追記（別操作・UNASSIGNED）
