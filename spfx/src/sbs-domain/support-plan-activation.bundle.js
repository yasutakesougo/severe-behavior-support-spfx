...
__export(support_plan_activation_spfx_entry_exports, {
  SUPPORT_PLAN_ACTIVATION_LIVE_WRITE_AUTHORIZED: () => SUPPORT_PLAN_ACTIVATION_LIVE_WRITE_AUTHORIZED,
...
function validateSupportPlan(value) {
  ...
  if (typeof value.PlanId !== "string" || value.PlanId.trim() === "" || typeof value.OrganizationId !== "string" || value.OrganizationId.trim() === "" || typeof value.SiteId !== "string" || value.SiteId.trim() === "" || typeof value.UserId !== "string" || value.UserId.trim() === "" || typeof value.currentVersion !== "number" || !Number.isInteger(value.currentVersion) || value.currentVersion < 1 || typeof value.createdBy !== "string" || value.createdBy.trim() === "" || !isValidIsoDateTime(value.createdAt) || typeof value.version !== "number" || !Number.isInteger(value.version) || value.version < 1) {
    return false;
  }
  ...
  if (hasRetBy || hasRetAt || hasRetCode) {
    ...
    if (!isNonEmptyString(value.returnedBy) || !isValidIsoDateTime(value.returnedAt) || !isReasonCode(value.returnReasonCode)) {
      return false;
    }
  ...
  if (status === "Draft") {
    if (hasSubBy || hasRetBy || value.approvedBy !== void 0 || value.approvedAt !== void 0 || value.effectiveFrom !== void 0 || value.effectiveTo !== void 0 || value.closedBy !== void 0 || value.closedAt !== void 0 || value.closeReasonCode !== void 0 || value.closeReasonText !== void 0) {
      return false;
    }
    ...
    if (hasRetBy || value.approvedBy !== void 0 || value.approvedAt !== void 0 || value.effectiveFrom !== void 0 || value.effectiveTo !== void 0 || value.closedBy !== void 0 || value.closedAt !== void 0 || value.closeReasonCode !== void 0 || value.closeReasonText !== void 0) {
      return false;
    }
    ...
    if (value.approvedBy !== void 0 || value.approvedAt !== void 0 || value.effectiveFrom !== void 0 || value.effectiveTo !== void 0 || value.closedBy !== void 0 || value.closedAt !== void 0 || value.closeReasonCode !== void 0 || value.closeReasonText !== void 0) {
      return false;
    }
    ...
    if (!isNonEmptyString(value.approvedBy) || !isValidIsoDateTime(value.approvedAt) || !isValidIsoDateTime(value.effectiveFrom)) {
      return false;
    }
    if (value.effectiveTo !== void 0 && !isValidIsoDateTime(value.effectiveTo)) {
      return false;
    }
    if (value.effectiveTo !== void 0 && new Date(value.effectiveTo).getTime() < new Date(value.effectiveFrom).getTime()) {
      return false;
    }
    if (value.closedBy !== void 0 || value.closedAt !== void 0 || value.closeReasonCode !== void 0 || value.closeReasonText !== void 0) {
      return false;
    }
    ...
    if (!isNonEmptyString(value.approvedBy) || !isValidIsoDateTime(value.approvedAt) || !isValidIsoDateTime(value.effectiveFrom) || !isValidIsoDateTime(value.effectiveTo) || !isNonEmptyString(value.closedBy) || !isValidIsoDateTime(value.closedAt) || !isReasonCode(value.closeReasonCode)) {
      return false;
    }
...
function validateSupportPlanVersion(value) {
  ...
  if (typeof value.planId !== "string" || value.planId.trim() === "" || typeof value.OrganizationId !== "string" || value.OrganizationId.trim() === "" || typeof value.SiteId !== "string" || value.SiteId.trim() === "" || typeof value.UserId !== "string" || value.UserId.trim() === "" || typeof value.version !== "number" || !Number.isInteger(value.version) || value.version < 1 || !Array.isArray(value.goals) || !Array.isArray(value.supportMethods) || !Array.isArray(value.precautions) || !Array.isArray(value.reviewCriteria) || typeof value.versionCreatedBy !== "string" || value.versionCreatedBy.trim() === "" || !isValidIsoDateTime(value.versionCreatedAt)) {
    return false;
  }
  const isStringArray = (arr) => arr.every((item) => typeof item === "string" && item.trim() !== "");
  if (!isStringArray(value.goals) || !isStringArray(value.supportMethods) || !isStringArray(value.precautions) || !isStringArray(value.reviewCriteria)) {
    return false;
  }
  return true;
}
...
function validateSupportPlanVersionMonitoringPeriodReviewBinding(value) {
  ...
  return isNonEmptyString(value.OrganizationId) && isNonEmptyString(value.SiteId) && isNonEmptyString(value.UserId) && isNonEmptyString(value.planId) && typeof value.planVersion === "number" && Number.isInteger(value.planVersion) && value.planVersion >= 1 && typeof value.reviewedPlanVersion === "number" && Number.isInteger(value.reviewedPlanVersion) && value.reviewedPlanVersion >= 1 && value.planVersion > value.reviewedPlanVersion && isNonEmptyString(value.sourceOutcomeId) && isValidIsoDateTime(value.boundAt) && isNonEmptyString(value.boundBy);
}
...
function validateSupportPlanRevisionDraftCandidate(value) {
  ...
  return validateSupportPlanVersion(value.candidate) && validateSupportPlanVersionMonitoringPeriodReviewBinding(value.reviewBinding);
}
...
function validateActivationReceipt(value) {
  ...
  const receipt = value;
  return isNonEmptyString(receipt.planId) && typeof receipt.fromVersion === "number" && Number.isInteger(receipt.fromVersion) && receipt.fromVersion >= 1 && typeof receipt.activatedVersion === "number" && Number.isInteger(receipt.activatedVersion) && receipt.activatedVersion >= 1 && receipt.activatedVersion === receipt.fromVersion + 1 && isValidIsoDateTime(receipt.activatedAt) && isNonEmptyString(receipt.activatedBy) && isNonEmptyString(receipt.RevisionIntentId) && isNonEmptyString(receipt.DraftSnapshotId);
}
function applySupportPlanActivation(request) {
  ...
  if (!Number.isInteger(expectedCurrentVersion) || expectedCurrentVersion < 1 || !Number.isInteger(expectedRowVersion) || expectedRowVersion < 1) {
  ...
  const candidate = draft.candidate;
  const binding = draft.reviewBinding;
  if (currentPlan.PlanId !== candidate.planId || currentPlan.OrganizationId !== candidate.OrganizationId || currentPlan.SiteId !== candidate.SiteId || currentPlan.UserId !== candidate.UserId || currentPlan.PlanId !== binding.planId || currentPlan.OrganizationId !== binding.OrganizationId || currentPlan.SiteId !== binding.SiteId || currentPlan.UserId !== binding.UserId || draft.RevisionIntentId.length === 0) {
  ...
  if (existingReceipt && validateActivationReceipt(existingReceipt) && existingReceipt.DraftSnapshotId === confirmedDraftSnapshotId && existingReceipt.RevisionIntentId === draft.RevisionIntentId && existingReceipt.planId === currentPlan.PlanId && existingReceipt.activatedVersion === candidate.version && currentPlan.currentVersion === candidate.version) {
    return {
  ...
  if (nextPlan.approvedBy !== currentPlan.approvedBy || nextPlan.approvedAt !== currentPlan.approvedAt || nextPlan.effectiveFrom !== currentPlan.effectiveFrom) {
