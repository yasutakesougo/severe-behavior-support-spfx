...
// src/domain/procedure-record-cancellation-staff-save.ts
function buildProcedureRecordCancellationSubmitRequest(input) {
  return {
    semanticsInput: {
      operation: "CANCEL",
...
function persistStaffProcedureRecordCancellation(input, port) {
  return __async(this, null, function* () {
    ...
    const result = yield port.submitCancellation(request);
    return {
...
function resubmitFrozenProcedureRecordCancellation(request, port) {
  return __async(this, null, function* () {
    const result = yield port.submitCancellation(request);
    return {
      saveState: result.saveState,
