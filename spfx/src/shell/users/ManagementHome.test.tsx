...
import { MANAGEMENT_HOME_RESOLVED_FIXTURE, MANAGEMENT_HOME_UNAVAILABLE_FIXTURE } from "./management-home-fixture";
...
describe("SBS-MGMT-HOME-C view", () => {
  it("renders the locked information hierarchy", () => {
    const html = renderToStaticMarkup(
      <ManagementHome presentation={buildManagementHomeReadModel(MANAGEMENT_HOME_RESOLVED_FIXTURE)} />,
    );
  ...
  it("shows fail-closed copy when sources are unavailable", () => {
    const html = renderToStaticMarkup(
      <ManagementHome presentation={buildManagementHomeReadModel(MANAGEMENT_HOME_UNAVAILABLE_FIXTURE)} />,
    );
