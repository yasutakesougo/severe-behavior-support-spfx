#!/usr/bin/env node
/**
 * Interactive serve for SBS-MGMT-LOOP-B / #583 Actual Staff Plan-Transition Check.
 * Builds the synthetic Planning-PC harness and keeps http://127.0.0.1:4194 open.
 * No Puppeteer. No SharePoint / Deploy / LIVE WRITE.
 */
