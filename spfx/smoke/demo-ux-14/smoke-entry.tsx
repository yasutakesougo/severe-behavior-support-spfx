/**
 * DEMO-UX-14 browser smoke harness — synthetic fixture only.
 * Saving progress cue + interaction pause appearance (RPF-007).
 * No save / SharePoint write / autosave / saving→saved auto-complete.
 */
