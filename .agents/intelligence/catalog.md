...
| KI-UI-004 | OBSERVED | accessibility runtime / touch verification | UI / accessibility review lens | NONE（promotion 待ち） | jakubkrehel/skills better-accessibility, observed 2026-08-26 | accessibility runtime, touch target, keyboard-only, 200% zoom, reflow, forced-colors, better-accessibility | `observations/KI-UI-004.md` |
| KI-UI-005 | OBSERVED | rendered evidence usability review | UI / rendered usability review | NONE（promotion 待ち） | Superfuture/design-review, observed 2026-08-26 | rendered usability, screenshot review, visual hierarchy, spacing review, component state, rendered-usability-review | `observations/KI-UI-005.md` |
| KI-UI-006 | OBSERVED | adaptive / tablet layout review | UI / responsive layout review lens | NONE（promotion 待ち） | jakubkrehel/skills better-layout, observed 2026-08-26 | adaptive layout, tablet layout, responsive review, breakpoints, safe area, clipping, better-layout | `observations/KI-UI-006.md` |
| KI-UI-007 | OBSERVED | field relationship / empty-state structure | UI / component-pattern review | NONE（promotion 待ち） | coss ui `19620ae8...`, observed 2026-08-26 | coss ui, field, label, validation error, empty state, action hierarchy, pattern translation | `observations/KI-UI-007.md` |
| KI-UI-008 | OBSERVED | filter-state / presentation separation and explicit list states | UI / component-pattern review | NONE（promotion 待ち） | ReUI v2.3.0 `0daf79df...`, observed 2026-08-26 | ReUI, filters, state model, presentation chrome, data grid, loading, empty, record count, density, pattern translation | `observations/KI-UI-008.md` |
