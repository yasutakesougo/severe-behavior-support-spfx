/**
 * Pure TypeScript SHA-256 (UTF-8 string → lowercase hex).
 * Runtime-independent: no node: builtins, no browser globals beyond TextEncoder.
 * Spec vectors: empty string and "abc" are covered by contract tests.
 */
